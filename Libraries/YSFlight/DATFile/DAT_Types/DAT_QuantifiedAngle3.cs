...
namespace Com.OfficerFlake.Libraries.YSFlight.Files.DAT
{
    ...
    {
        public class DAT_QuantifiedAngle3 : Property
        {
            private const string NullExceptionString = "<ERROR-DAT_QuantifiedAngle3>";
            ...
            public DAT_QuantifiedAngle3(string command, int quantifier,Angle h, Angle p, Angle b) : base(command, h, p, b)
            {
