namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Speeds
        {
            ...
            {
                public FeetPerSecond(decimal value) : base(value, Conversion.FeetPerSecond, "FT/S") { }
            ...
            public static FeetPerSecond FeetPerSeconds(this float input) => new FeetPerSecond((decimal)input);
            public static FeetPerSecond FeetPerSeconds(this double input) => new FeetPerSecond((decimal)input);
            public static FeetPerSecond FeetPerSeconds(this decimal input) => new FeetPerSecond(input);
        }
    }
}
