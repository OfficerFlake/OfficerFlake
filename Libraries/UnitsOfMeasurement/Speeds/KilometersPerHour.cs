namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Speeds
        {
            ...
            {
                public KilometersPerHour(decimal value) : base(value, Conversion.KilometersPerHour, "KPH") { }
            ...
            public static KilometersPerHour KilometersPerHours(this float input) => new KilometersPerHour((decimal)input);
            public static KilometersPerHour KilometersPerHours(this double input) => new KilometersPerHour((decimal)input);
            public static KilometersPerHour KilometersPerHours(this decimal input) => new KilometersPerHour(input);
        }
    }
}
