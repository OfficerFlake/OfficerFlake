namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Durations
        {
            ...
            {
                public Month(decimal value) : base(value, Conversion.Month, "D") { }
            ...
            public static Month Months(this float input) => new Month((decimal)input);
            public static Month Months(this double input) => new Month((decimal)input);
            public static Month Months(this decimal input) => new Month(input);
        }
    }
}
