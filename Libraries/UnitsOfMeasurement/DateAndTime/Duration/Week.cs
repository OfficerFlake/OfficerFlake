namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Durations
        {
            ...
            {
                public Week(decimal value) : base(value, Conversion.Week, "D") { }
            ...
            public static Week Weeks(this float input) => new Week((decimal)input);
            public static Week Weeks(this double input) => new Week((decimal)input);
            public static Week Weeks(this decimal input) => new Week(input);
        }
    }
}
