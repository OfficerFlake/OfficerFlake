namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Durations
        {
            ...
            {
                public Year(decimal value) : base(value, Conversion.Year, "D") { }
            ...
            public static Year Years(this float input) => new Year((decimal)input);
            public static Year Years(this double input) => new Year((decimal)input);
            public static Year Years(this decimal input) => new Year(input);
        }
    }
}
