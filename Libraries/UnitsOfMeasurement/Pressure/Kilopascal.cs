namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Pressures
        {
            ...
            {
                public KiloPascal(double value) : base(value, Conversion.KiloPascal, "KP") { }
            ...
            public static KiloPascal KiloPascals(this float input) => new KiloPascal((double)input);
            public static KiloPascal KiloPascals(this double input) => new KiloPascal((double)input);
        }
    }
}
