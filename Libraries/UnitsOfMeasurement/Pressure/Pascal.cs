namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Pressures
        {
            ...
            {
                public Pascal(decimal value) : base(value, Conversion.Pascal, "P") { }
            ...
            public static Pascal Pascals(this float input) => new Pascal((decimal)input);
            public static Pascal Pascals(this double input) => new Pascal((decimal)input);
            public static Pascal Pascals(this decimal input) => new Pascal(input);
        }
    }
}
