namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public CubicCentimeter(decimal value) : base(value, Conversion.CubicCentimeter, "CM^3") { }
            ...
            public static CubicCentimeter CubicCentimeters(this float input) => new CubicCentimeter((decimal)input);
            public static CubicCentimeter CubicCentimeters(this double input) => new CubicCentimeter((decimal)input);
            public static CubicCentimeter CubicCentimeters(this decimal input) => new CubicCentimeter(input);
        }
    }
}
