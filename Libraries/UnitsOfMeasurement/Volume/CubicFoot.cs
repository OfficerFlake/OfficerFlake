namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public CubicFoot(decimal value) : base(value, Conversion.CubicFoot, "FT^3") { }
            ...
            public static CubicFoot CubicFeet(this float input) => new CubicFoot((decimal)input);
            public static CubicFoot CubicFeet(this double input) => new CubicFoot((decimal)input);
            public static CubicFoot CubicFeet(this decimal input) => new CubicFoot(input);
        }
    }
}
