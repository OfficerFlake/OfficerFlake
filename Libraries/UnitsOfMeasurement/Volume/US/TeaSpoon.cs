namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public USTeaSpoon(decimal value) : base(value, Conversion.US.TeaSpoon, "TSP") { }
            ...
            public static USTeaSpoon USTeaSpoons(this float input) => new USTeaSpoon((decimal)input);
            public static USTeaSpoon USTeaSpoons(this double input) => new USTeaSpoon((decimal)input);
            public static USTeaSpoon USTeaSpoons(this decimal input) => new USTeaSpoon(input);
        }
