namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public USGallon(decimal value) : base(value, Conversion.US.Gallon, "GALLON") { }
            ...
            public static USGallon USGallons(this float input) => new USGallon((decimal)input);
            public static USGallon USGallons(this double input) => new USGallon((decimal)input);
            public static USGallon USGallons(this decimal input) => new USGallon(input);
        }
