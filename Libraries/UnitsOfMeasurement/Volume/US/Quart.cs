namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public USQuart(decimal value) : base(value, Conversion.US.Quart, "QUART") { }
            ...
            public static USQuart USQuarts(this float input) => new USQuart((decimal)input);
            public static USQuart USQuarts(this double input) => new USQuart((decimal)input);
            public static USQuart USQuarts(this decimal input) => new USQuart(input);
        }
