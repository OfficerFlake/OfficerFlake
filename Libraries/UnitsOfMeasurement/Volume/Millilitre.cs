namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public Millilitre(decimal value) : base(value, Conversion.Millilitre, "ML") { }
            ...
            public static Millilitre Millilitres(this float input) => new Millilitre((decimal)input);
            public static Millilitre Millilitres(this double input) => new Millilitre((decimal)input);
            public static Millilitre Millilitres(this decimal input) => new Millilitre(input);
        }
    }
}
