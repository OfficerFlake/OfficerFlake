namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public UKTeaSpoon(decimal value) : base(value, Conversion.UK.TeaSpoon, "UKTSP") { }
            ...
            public static UKTeaSpoon UKTeaSpoons(this float input) => new UKTeaSpoon((decimal)input);
            public static UKTeaSpoon UKTeaSpoons(this double input) => new UKTeaSpoon((decimal)input);
            public static UKTeaSpoon UKTeaSpoons(this decimal input) => new UKTeaSpoon(input);
        }
