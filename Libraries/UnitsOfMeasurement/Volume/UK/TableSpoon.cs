namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Volumes
        {
            ...
            {
                public UKTableSpoon(decimal value) : base(value, Conversion.UK.TableSpoon, "UKTBLSP") { }
            ...
            public static UKTableSpoon UKTableSpoons(this float input) => new UKTableSpoon((decimal)input);
            public static UKTableSpoon UKTableSpoons(this double input) => new UKTableSpoon((decimal)input);
            public static UKTableSpoon UKTableSpoons(this decimal input) => new UKTableSpoon(input);
        }
