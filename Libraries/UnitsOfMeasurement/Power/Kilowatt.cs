namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Powers
        {
            ...
            {
                public KiloWatt(decimal value) : base(value, Conversion.KiloWatt, "KW") { }
            ...
            public static KiloWatt KiloWatts(this float input) => new KiloWatt((decimal)input);
            public static KiloWatt KiloWatts(this double input) => new KiloWatt((decimal)input);
            public static KiloWatt KiloWatts(this decimal input) => new KiloWatt(input);
        }
    }
}
