namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Distances
		{
            ...
            public static NauticalMile NauticalMiles(this float input) => new NauticalMile((decimal)input);
            public static NauticalMile NauticalMiles(this double input) => new NauticalMile((decimal)input);
            public static NauticalMile NauticalMiles(this decimal input) => new NauticalMile(input);
        }
    }
}
