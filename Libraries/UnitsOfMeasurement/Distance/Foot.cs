namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
	    public static partial class Distances
	    {
			...
			{
                public Foot(double value) : base(value, Conversion.Foot, "FT") { }
            ...
            public static Foot Feet(this float input) => new Foot((double)input);
            public static Foot Feet(this double input) => new Foot((double)input);
        }
    }
}
