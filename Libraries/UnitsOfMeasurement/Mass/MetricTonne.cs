namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public MetricTonne(double value) : base(value, Conversion.MetricTonne, "T") { }
            ...
            public static MetricTonne MetricTonnes(this float input) => new MetricTonne((double)input);
            public static MetricTonne MetricTonnes(this double input) => new MetricTonne((double)input);
        }
    }
}
