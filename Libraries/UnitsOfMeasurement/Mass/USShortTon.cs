namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public USShortTon(decimal value) : base(value, Conversion.USShortTon, "SHORTTON") { }
            ...
            public static USShortTon USShortTons(this float input) => new USShortTon((decimal)input);
            public static USShortTon USShortTons(this double input) => new USShortTon((decimal)input);
            public static USShortTon USShortTons(this decimal input) => new USShortTon(input);
        }
    }
}
