namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public Ounce(double value) : base(value, Conversion.Ounce, "OZ") { }
            ...
            public static Ounce Ounces(this float input) => new Ounce((double)input);
            public static Ounce Ounces(this double input) => new Ounce((double)input);
        }
    }
}
