namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public UKLongTon(double value) : base(value, Conversion.UKLongTon, "LONGTON") { }
            ...
            public static UKLongTon UKLongTons(this float input) => new UKLongTon((double)input);
            public static UKLongTon UKLongTons(this double input) => new UKLongTon((double)input);
        }
    }
}
