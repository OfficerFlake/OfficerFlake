namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public Hectogram(double value) : base(value, Conversion.Hectogram, "HG") { }
            ...
            public static Hectogram Hectograms(this float input) => new Hectogram((double)input);
            public static Hectogram Hectograms(this double input) => new Hectogram((double)input);
        }
    }
}
