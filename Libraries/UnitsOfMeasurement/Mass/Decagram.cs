namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public Decagram(double value) : base(value, Conversion.Decagram, "DaG") { }
            ...
            public static Decagram Decagrams(this float input) => new Decagram((double)input);
            public static Decagram Decagrams(this double input) => new Decagram((double)input);
        }
    }
}
