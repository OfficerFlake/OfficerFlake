namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Masses
        {
            ...
            {
                public Decigram(decimal value) : base(value, Conversion.Decigram, "DiG") { }
            ...
            public static Decigram Decigrams(this float input) => new Decigram((decimal)input);
            public static Decigram Decigrams(this double input) => new Decigram((decimal)input);
            public static Decigram Decigrams(this decimal input) => new Decigram(input);
        }
    }
}
