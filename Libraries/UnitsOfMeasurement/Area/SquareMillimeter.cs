namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Areas
        {
            ...
            {
                public SquareMillimeter(decimal value) : base(value, Conversion.SquareMillimeter, "MM^2") { }
            ...
            public static SquareMillimeter SquareMillimeters(this float input) => new SquareMillimeter((decimal)input);
            public static SquareMillimeter SquareMillimeters(this double input) => new SquareMillimeter((decimal)input);
            public static SquareMillimeter SquareMillimeters(this decimal input) => new SquareMillimeter(input);
        }
    }
}
