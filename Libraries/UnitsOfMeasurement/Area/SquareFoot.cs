namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Areas
        {
            ...
            {
                public SquareFoot(decimal value) : base(value, Conversion.SquareFoot, "FT^2") { }
            ...
            public static SquareFoot SquareFoots(this float input) => new SquareFoot((decimal)input);
            public static SquareFoot SquareFoots(this double input) => new SquareFoot((decimal)input);
            public static SquareFoot SquareFoots(this decimal input) => new SquareFoot(input);
        }
    }
}
