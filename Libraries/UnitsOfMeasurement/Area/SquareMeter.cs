namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Areas
        {
            ...
            {
                public SquareMeter(decimal value) : base(value, Conversion.SquareMeter, "M^2") { }
            ...
            public static SquareMeter SquareMeters(this float input) => new SquareMeter((decimal)input);
            public static SquareMeter SquareMeters(this double input) => new SquareMeter((decimal)input);
            public static SquareMeter SquareMeters(this decimal input) => new SquareMeter(input);
        }
    }
}
