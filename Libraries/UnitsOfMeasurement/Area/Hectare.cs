namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Areas
        {
            ...
            {
                public Hectare(decimal value) : base(value, Conversion.Hectare, "HA") { }
            ...
            public static Hectare Hectares(this float input) => new Hectare((decimal)input);
            public static Hectare Hectares(this double input) => new Hectare((decimal)input);
            public static Hectare Hectares(this decimal input) => new Hectare(input);
        }
    }
}
