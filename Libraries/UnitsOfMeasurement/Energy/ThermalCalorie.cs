namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Energys
        {
            ...
            {
                public ThermalCalorie(decimal value) : base(value, Conversion.ThermalCalorie, "THCAL") { }
            ...
            public static ThermalCalorie ThermalCalories(this float input) => new ThermalCalorie((decimal)input);
            public static ThermalCalorie ThermalCalories(this double input) => new ThermalCalorie((decimal)input);
            public static ThermalCalorie ThermalCalories(this decimal input) => new ThermalCalorie(input);
        }
    }
}
