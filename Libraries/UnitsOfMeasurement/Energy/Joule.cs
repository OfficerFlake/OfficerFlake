namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Energys
        {
            ...
            {
                public Joule(double value) : base(value, Conversion.Joule, "J") { }
            ...
            public static Joule Joules(this float input) => new Joule((double)input);
            public static Joule Joules(this double input) => new Joule((double)input);
        }
    }
}
