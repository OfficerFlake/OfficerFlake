namespace Com.OfficerFlake.Libraries
{
    namespace UnitsOfMeasurement
    {
        public static partial class Energys
        {
            ...
            {
                public FoodCalories(decimal value) : base(value, Conversion.FoodCalories, "CAL") { }
            ...
            public static FoodCalories FoodCaloriess(this float input) => new FoodCalories((decimal)input);
            public static FoodCalories FoodCaloriess(this double input) => new FoodCalories((decimal)input);
            public static FoodCalories FoodCaloriess(this decimal input) => new FoodCalories(input);
        }
    }
}
