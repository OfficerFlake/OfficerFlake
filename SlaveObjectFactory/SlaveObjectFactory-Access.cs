...
namespace Com.OfficerFlake.Libraries
{
	public static  partial class ObjectFactory
	{
		...
		public static  IPoint2 CreatePoint2(IDistance x, IDistance y)
		{
			throw new NotImplementedException();
		}
		public static  IPoint3 CreatePoint3(IDistance x, IDistance y, IDistance z)
		{
			throw new NotImplementedException();
		}
		...
		public static  IOrientation2 CreateOrientation2(IAngle h, IAngle p)
		{
			throw new NotImplementedException();
		}
		public static  IOrientation3 CreateOrientation3(IAngle h, IAngle p, IAngle b)
		{
			throw new NotImplementedException();
		}
		...
		#endregion
		#region Networking
		public static  IConnection CreateConnection(Socket socket)
		{
			throw new NotImplementedException();
		}
		public static  List<IConnection> AllConnections { get; set; }
		#endregion
		...
		public static List<IConnection> ExcludeConnections(List<IConnection> connections, IConnection exlude)
		{
			throw new NotImplementedException();
		}

		public static List<IConnection> ExcludeConnections(List<IConnection> connections, List<IConnection> exlude)
		{
			throw new NotImplementedException();
		}

		public static List<IConnection> IncludeConnections(List<IConnection> connections, IConnection include)
		{
			throw new NotImplementedException();
		}

		public static List<IConnection> IncludeConnections(List<IConnection> connections, List<IConnection> include)
		{
			throw new NotImplementedException();
		}
		...
		public static IPacket_04_Field CreatePacket04Field()
		{
			throw new NotImplementedException();
		}
		...
		public static IPacket_31_MissilesOption CreatePacket31MissilesOption()
		{
			throw new NotImplementedException();
		}
		...
		public static List<IMetaDataAircraft> MetaDataAllAircraft { get; }
		public static List<IMetaDataGround> MetaDataAllGrounds { get; }
		public static List<IMetaDataScenery> MetaDataAllScenerys { get; }

		public static List<IWorldAircraftObject> WorldAllAircraft { get; set; }
		public static List<IWorldGroundObject> WorldAllGrounds { get; set; }
		public static List<IWorldStartPosition> WorldAllStartPositions { get; set; }
		#endregion
	}
}
